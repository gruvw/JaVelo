...
public record GraphSectors(ByteBuffer buffer) {
        ...
        /**
         * Number of sectors per axis on the grid covering Switzerland. The total number of sectors
         * is therefore {@code SECTORS_PER_AXIS}².
         */
        ...
        /**
         * Lists all sectors having an intersection with a given {@code center} and of length equal
         * to twice the given {@code distance}.
         * <p>
         ...
         *                 (supposed positive or 0)
         * @return a list of all sectors intersecting with the square centered at {@code center} and
         *         of side length equals to twice the {@code distance}
         */
        public List<Sector> sectorsInArea(PointCh center, double distance) {
                ...
                for (int y = 0; y <= height; y++)
                        for (int x = 0; x <= width; x++) {
                                ...
                                int nodeCount = Short.toUnsignedInt(buffer.getShort(
                                                sectorNb * SECTOR_SIZE + OFFSET_NODE_COUNT));
