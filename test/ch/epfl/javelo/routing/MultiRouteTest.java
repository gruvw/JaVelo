...
public class MultiRouteTest {
        ...
        static Stream<Arguments> indexOfSegmentAtTest() {
                return Stream.of(Arguments.of(route, -100, 0), Arguments.of(route, 0, 0),
                                ...
                                Arguments.of(mr1, 1990, 1), Arguments.of(mr1, 2010, 2),
                                Arguments.of(mr1, 2500, 2), Arguments.of(mr1, 2990, 2),
                                Arguments.of(mr1, 3000, 2), Arguments.of(mr2, -100, 0),
        ...
        static Stream<Arguments> elevationAtTest() {
                return Stream.of(Arguments.of(-100, 1), Arguments.of(0, 1), Arguments.of(200, 1),
                                ...
                                Arguments.of(3800, 8), Arguments.of(4200, 9),
                                Arguments.of(4800, 10), Arguments.of(5200, 11),
                                Arguments.of(5800, 12), Arguments.of(8000, 12));
        }
