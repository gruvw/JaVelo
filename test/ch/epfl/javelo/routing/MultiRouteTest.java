...
public class MultiRouteTest {
        ...
        static Stream<Arguments> indexOfSegmentAtTest() {
                return Stream.of(Arguments.of(route, -100, 0), Arguments.of(route, 0, 0),
                                ...
                                Arguments.of(route, 6600, 5), Arguments.of(mr1, -100, 0),
                                Arguments.of(mr1, 0, 0), Arguments.of(mr1, 100, 0),
                                Arguments.of(mr1, 401, 0), Arguments.of(mr1, 601, 0),
                                Arguments.of(mr1, 1001, 1), Arguments.of(mr1, 1500, 1),
                                Arguments.of(mr1, 1990, 1), Arguments.of(mr1, 2000, 2),
                                Arguments.of(mr1, 2010, 2), Arguments.of(mr1, 2500, 2),
                                Arguments.of(mr1, 2990, 2), Arguments.of(mr1, 3000, 2),
                                Arguments.of(mr2, -100, 0), Arguments.of(mr2, 0, 0),
                                Arguments.of(mr2, 100.5543, 0), Arguments.of(mr2, 400.001, 0),
                                Arguments.of(mr2, 599.999, 0), Arguments.of(mr2, 1000.001, 1),
                                Arguments.of(mr2, 1500.24124, 1), Arguments.of(mr2, 1999.999, 1),
                                Arguments.of(mr2, 2000.001, 2), Arguments.of(mr2, 3000, 2),
                                Arguments.of(mrOneSegment, -100, 0),
                                Arguments.of(mrOneSegment, 0, 0),
                                Arguments.of(mrOneSegment, 100, 0),
                                Arguments.of(mrOneSegment, 252.252, 0),
                                Arguments.of(mrOneSegment, 300, 0),
                                Arguments.of(mrSingleAndMulti, -100, 0),
                                Arguments.of(mrSingleAndMulti, 0, 0),
                                Arguments.of(mrSingleAndMulti, 1100, 1),
                                Arguments.of(mrSingleAndMulti, 2100, 2),
                ...
                return Stream.of(
                                Arguments.of(mr1,
                                                Arrays.asList(edge1, edge2, edge3, edge4, edge5,
                                                                edge6)),
                                Arguments.of(mr2,
                                                Arrays.asList(edge7, edge8, edge9, edge10, edge11,
                                                                edge12)),
                                Arguments.of(route,
                                                Arrays.asList(edge1, edge2, edge3, edge4, edge5,
                                                                edge6, edge7, edge8, edge9, edge10,
                                                                edge11, edge12)),
                                Arguments.of(mrSingleAndMulti, Arrays.asList(edge1, edge2, edge3,
        ...
        static Stream<Arguments> pointsTest() {
                return Stream.of(
                                ...
                                Arguments.of(mr2,
                                                Arrays.asList(point7, point8, point9, point10,
                                                                point11, point12, point13)),
                                Arguments.of(route, Arrays.asList(point1, point2, point3, point4,
                                ...
                                Arguments.of(mrSingleAndMulti, Arrays.asList(point1, point2, point3,
        ...
        static Stream<Arguments> pointAtTest() {
                return Stream.of(Arguments.of(route, -100, point1), Arguments.of(route, 0, point1),
                                ...
                                Arguments.of(route, 1600, point4),
                                Arguments.of(route, 2000, point5),
                                Arguments.of(route, 2600, point6),
                                Arguments.of(route, 3000, point7),
                                Arguments.of(route, 3400, point8),
                                Arguments.of(route, 4000, point9),
                                Arguments.of(route, 4600, point10),
                                Arguments.of(route, 5000, point11),
                                Arguments.of(route, 5600, point12),
                                Arguments.of(route, 6000, point13),
        ...
        static Stream<Arguments> elevationAtTest() {
                return Stream.of(Arguments.of(route, -100, 1), Arguments.of(route, 0, 1),
                                ...
                                Arguments.of(route, 8000, 12),
                                Arguments.of(mrOneSegment, -100, 100),
                                Arguments.of(mrOneSegment, 0, 100),
                                Arguments.of(mrOneSegment, 100, 100),
                                Arguments.of(mrOneSegment, 252.252, 100),
                                Arguments.of(mrOneSegment, 300, 100));
        }
        ...
        static Stream<Arguments> nodeClosestToTest() {
                return Stream.of(Arguments.of(-10, 1), Arguments.of(0, 1), Arguments.of(10, 1),
                                Arguments.of(200 - 0.1, 1), Arguments.of(200 + 0.1, 2),
                                Arguments.of(400, 2), Arguments.of(1000 - 0.1, 3),
                                Arguments.of(1000 + 0.1, 3), Arguments.of(2500, 6),
        ...
        void pointClosestToTest() {
                ...
                TestUtils.assertEqualsRoutePoint(expected, mrGGB.pointClosestTo(
                                new PointCh(SwissBounds.MIN_E + 4, SwissBounds.MIN_N + 1.5)),
                                DELTA);
                expected = new RoutePoint(pointS, 10.147065226, 1.5);
                TestUtils.assertEqualsRoutePoint(expected, mrGGB.pointClosestTo(
                                new PointCh(SwissBounds.MIN_E + 5.5, SwissBounds.MIN_N + 4.7)),
                                DELTA);
                expected = new RoutePoint(pointE, mrGGB.length(), 1.5652475842);
                TestUtils.assertEqualsRoutePoint(expected, mrGGB.pointClosestTo(
                                new PointCh(SwissBounds.MIN_E + 3.3, SwissBounds.MIN_N + 7.4)),
                                DELTA);
        }
