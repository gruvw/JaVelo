...
class PointChTest {
    ...
    void pointChConstructorThrowsOnInvalidCoordinates() {
        assertThrows(IllegalArgumentException.class, () -> {
            new PointCh(2484999, 1.2e6);
        });
        assertThrows(IllegalArgumentException.class, () -> {
            new PointCh(2834001, 1.2e6);
        });
        assertThrows(IllegalArgumentException.class, () -> {
            new PointCh(2.6e6, 1074999);
        });
        assertThrows(IllegalArgumentException.class, () -> {
            new PointCh(2.6e6, 1296001);
        });
    }
    ...
    void pointChSquaredDistanceToWorksOnKnownValues() {
        var actual1 = new PointCh(2.6e6, 1.2e6).squaredDistanceTo(new PointCh(2.6e6, 1.2e6));
        var expected1 = 0.0;
        assertEquals(expected1, actual1, DELTA);

        var actual2 = new PointCh(2.6e6, 1.2e6).squaredDistanceTo(new PointCh(2600100, 1.2e6));
        var expected2 = 10000.0;
        assertEquals(expected2, actual2, DELTA);

        var actual3 = new PointCh(2.6e6, 1.2e6).squaredDistanceTo(new PointCh(2.6e6, 1200100));
        var expected3 = 10000.0;
        assertEquals(expected3, actual3, DELTA);

        var actual4 = new PointCh(2.6e6, 1.2e6).squaredDistanceTo(new PointCh(2601234, 1201234));
    ...
    void pointChDistanceToWorksOnKnownValues() {
        var actual1 = new PointCh(2.6e6, 1.2e6).distanceTo(new PointCh(2.6e6, 1.2e6));
        var expected1 = 0.0;
        assertEquals(expected1, actual1, DELTA);

        var actual2 = new PointCh(2.6e6, 1.2e6).distanceTo(new PointCh(2485001, 1075001));
        var expected2 = 169851.4645270979;
        assertEquals(expected2, actual2, DELTA);

        var actual3 = new PointCh(2485001, 1075001).distanceTo(new PointCh(2833999, 1295999));
        var expected3 = 413085.60857042694;
        assertEquals(expected3, actual3, DELTA);

        var actual4 = new PointCh(2700000, 1100000).distanceTo(new PointCh(2833999, 1295999));
    ...
    void pointChLonWorksWithKnownValues() {
        var actual1 = new PointCh(2.6e6, 1.2e6).lon();
    ...
    void pointChLatWorksWithKnownValues() {
        var actual1 = new PointCh(2.6e6, 1.2e6).lat();
