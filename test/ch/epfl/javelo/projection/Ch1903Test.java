...
class Ch1903Test {
    ...
    public void eWorksOnKnownValues(double lon, double lat, double expected) {
    ...
    public void nWorksOnKnownValues(double lon, double lat, double expected) {
    ...
    public void lonWorksOnKnownValues(double e, double n, double expected) {
    ...
    public void latWorksOnKnownValues(double e, double n, double expected) {
